                ...
                <div class="col-md-8 col-12">
                    <div class="details-right text-md-left">
                        ...
                        <button
                            ...
                            @click="openTrailer(movie.videos && movie.videos.results)">
                    ...
                    <div class="d-flex flex-wrap">
                        <div v-for="(castMember) in movie.credits.cast.slice(0, showMoreCast ? undefined : maxVisibleCastMembers)"
                            ...
                            <div class="h-100 card">
                                <img v-if="castMember.profile_path"
                                    :src="`https://image.tmdb.org/t/p/w500${castMember.profile_path}`" />
                                <img v-else src="@/assets/img/fallback.jpg" alt="Fallback Image" />
                                <div class="card-body">
